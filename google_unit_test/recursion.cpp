...
TEST(FindNumOccurance, General)
{
    ...
    EXPECT_EQ(1, find_target_number_occurance(arr2, 0, 1, 1));
    EXPECT_EQ(1, find_target_number_occurance(arr3, 0, 2, 1));
    EXPECT_EQ(3, find_target_number_occurance(arr4, 0, 3, 3));
    EXPECT_EQ(3, find_target_number_occurance(arr5, 0, 4, 2));
    EXPECT_EQ(6, find_target_number_occurance(arr6, 0, 5, 2));
    EXPECT_EQ((-1), find_target_number_occurance(arr6, 0, 5, 1));
}
...
TEST(FindFirstMissingNumber, Test_missing_num)
{
    int a1[1] = {1};
    int a2[2] = {2, 4};
    int a3[3] = {2, 3, 4};
    ...
    EXPECT_EQ(0, find_first_missing_number(a1, 1));
    EXPECT_EQ(3, find_first_missing_number(a2, 2));
    EXPECT_EQ(0, find_first_missing_number(a3, 3));
    EXPECT_EQ(4, find_first_missing_number(a4, 4));
    EXPECT_EQ(3, find_first_missing_number(a5, 4));
    EXPECT_EQ(4, find_first_missing_number(a6, 6));
    EXPECT_EQ(5, find_first_missing_number(a7, 7));
}
